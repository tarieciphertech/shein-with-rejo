  ...
  return (
    <section className="pt-32 pb-24 lg:pt-44 min-h-[80vh] flex items-center">
      ...
      <div className="section-padding w-full max-w-md mx-auto">
        <Link to="/" className="inline-flex items-center gap-1.5 text-sm text-charcoal/60 dark:text-cream/60 hover:text-clay transition-colors mb-8">
        ...
        <div className="card p-8">
          ...
          <p className="text-sm text-charcoal/60 dark:text-cream/60 mb-8">
            For the SHEIN with Rejo team only.
          </p>

          {error && (
            <div role="alert" className="mb-5 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 rounded-xl p-3.5 text-sm text-red-700 dark:text-red-300">
              {error}
            </div>
          )}
